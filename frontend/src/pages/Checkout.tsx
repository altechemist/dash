...
export default function Checkout() {
  ...
  const validateForm = () => {
    const { firstName, lastName, username, address, country, state, zip } =
      formData;
    const isValid =
      firstName && lastName && username && address && country && state && zip;
  ...
  return (
    <div className="container">
      <div className="col-md-7 col-lg-8">
        ...
        {isFormValid && <PayPalButtonComponent formData={formData} cart={cart} />}
      </div>
    </div>
  );
}
